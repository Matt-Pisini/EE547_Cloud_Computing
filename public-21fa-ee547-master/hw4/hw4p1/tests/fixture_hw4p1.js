...
// match defaults
const DEFAULT_ENTRY_FEE = '6.00';
const DEFAULT_PRIZE = '10.00';
...
Hw4P1Fixture.assert_valid_match = (obj) => {
  const fields = [
    'mid',
    'entry_fee_usd',
    'p1_id',
...
Hw4P1Fixture.assert_valid_match_document = (obj) => {
  const fields = [
    '_id',
    'entry_fee_usd',
    'p1_id',
...
chai.use(function (chai) {
  ...
  Assertion.addMethod('document', function (exp) {
    ...
    const validators = {
      match:  Hw4P1Fixture.assert_valid_match_document,
  ...
  Assertion.addMethod('model', function (exp) {
    ...
    const validators = {
      match:          Hw4P1Fixture.assert_valid_match,
