...
Hw5P1Fixture.assert_valid_match = (obj) => {
  const fields = [
    'mid',
    'entry_fee_usd_cents',
    'p1_id',
...
Hw5P1Fixture.assert_valid_match_document = (obj) => {
  const fields = [
    '_id',
    'entry_fee_usd_cents',
    'p1_id',
...
chai.use(function (chai) {
  ...
  Assertion.addMethod('document', function (exp) {
    ...
    const validators = {
      match:  Hw5P1Fixture.assert_valid_match_document,
  ...
  Assertion.addMethod('model', function (exp) {
    ...
    const validators = {
      match:          Hw5P1Fixture.assert_valid_match,
